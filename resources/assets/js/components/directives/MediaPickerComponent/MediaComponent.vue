<template>
  <div class="card" id="media-picker-select">
  	<div class="card-header d-flex">
		...
		<media-library-picker-component :i-key="iKey" @mediaLibrary:filesSelected="onFilesSelected" :is-open="isOpen" :multiple="multiple"></media-library-picker-component>
  </div>
</template>

<script>
	export default {
		props: ['defaultFiles', 'multiple', 'iKey'],
		data: function(){
			return {
				files: [],
				isOpen: false,
