										...
										<div class="card card-plain">
											...
											<div id="icon" class="collapse" role="tabpanel" aria-labelledby="headingTwo">
												<div class="card-body text-center">
													<img src="{{ asset('storage/directory/' . $directory['icon']) }}" class="border-gray img-thumbnail">
												</div>
											</div>
										</div>
										<div class="card card-plain">
											...
											<div id="collapseTwo" class="collapse" role="tabpanel" aria-labelledby="headingTwo">
												<div class="card-body text-center">
													<img src="{{ asset('storage/directory/' . $directory['location_image']) }}" class="border-gray img-thumbnail">
												</div>
											</div>
										</div>
										<div class="card card-plain">
												...
												<div class="card-body text-center">
													@if (isset($directoryImages))
														@foreach ($directoryImages as $directoryImage)
															<img src="{{ asset('storage/directory/banners/' . $directoryImage['banner_image']) }}" id="icon" class="border-gray img-thumbnail mx-2">
														@endforeach
													@endif
												</div>
											</div>
